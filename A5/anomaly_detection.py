...
if __name__ == "__main__":
    # change the 'features' column from string representation to a list
    df = pd.read_csv('logs-features-sample.csv', converters= {'features': ast.literal_eval}).set_index('id')
    ad = AnomalyDetection()
